package com.github.largeessentiagenerator.common.gregtech.metatileentity;
...
import com.github.largeessentiagenerator.common.gregtech.EssentiaLogic;
import com.github.largeessentiagenerator.common.gregtech.predicate.EssentiaCellPredicate;
import com.github.largeessentiagenerator.common.gregtech.predicate.TileEntityPredicate;
...
import static com.github.largeessentiagenerator.client.Textures.LARGE_ESSENTIA_GENERATOR;
import static com.github.largeessentiagenerator.common.gregtech.metablock.EGMetaCasing.MetalCasingType.MAGIC_CASING;
...
public class MetaTileEntityEssentiaGenerator extends MultiblockWithDisplayBase implements IDataInfoProvider, IWorkable {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("##TCXCT##", "###CEC###", "#########")
                .aisle("#TCCXCCT#", "##CEEEC##", "#########")
                .aisle("TCCCXCCCT", "#CEEEEEC#", "#########")
                .aisle("XXXXXXXXX", "CEEEEEEEC", "####S####")
                .aisle("TCCCXCCCT", "#CEEEEEC#", "#########")
                .aisle("#TCCXCCT#", "##CEEEC##", "#########")
                .aisle("##TCXCT##", "###CEC###", "#########")
                .aisle("T##TXT##T", "T###C###T", "A#######A")
                ...
                .where('X',
                        abilities(MultiblockAbility.MAINTENANCE_HATCH).setExactLimit(1)
                                ...
                                .or(abilities(MultiblockAbility.IMPORT_FLUIDS).setMinGlobalLimited(0))
                                .or(TileEntityPredicate.get(EssentiaHatch.class, this).setMinGlobalLimited(1))
                                .or(states(getCasing())))
                .where('#', any())
                .build();
    }
    ...
    public IBlockState getCasing() {
        return EGMetaBlocks.EG_BLOCK_CASING.getState(MAGIC_CASING);
    }
